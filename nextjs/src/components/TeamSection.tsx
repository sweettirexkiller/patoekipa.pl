    ...
    >
      <div className={`relative w-full h-full transition-transform duration-700 transform-style-preserve-3d ${
        ...
        <div className="absolute inset-0 w-full h-full backface-hidden">
          <div className="glass rounded-3xl overflow-hidden shadow-lg hover:shadow-xl h-full flex flex-col">
            {/* Avatar Section */}
              ...
              <div className="mb-4">
                <div className="flex flex-wrap gap-2">
                  {member.skills.slice(0, 3).map((skill, skillIndex) => (
                    <span
                      key={skill}
                      className="px-3 py-1.5 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 text-blue-700 dark:text-blue-300 text-sm rounded-xl font-medium border border-blue-100 dark:border-blue-800/30"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            <div className="p-6 flex-1 flex flex-col justify-between min-h-0">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {member.skills.map((skill, skillIndex) => (
                      <span
                        key={skill}
                        className="px-2.5 py-1 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 text-blue-700 dark:text-blue-300 text-xs rounded-lg font-medium border border-blue-100 dark:border-blue-800/30 hover:scale-105 transition-transform duration-200"
                      >
                        {skill}
                      </span>
                    ))}
              ...
              <div className="mt-4 space-y-3 flex-shrink-0">
                ...
                <a
                  ...
                  className="block w-full px-4 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-center text-sm"
                >
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 glass rounded-xl py-2 px-3 flex items-center justify-center hover:bg-white/30 dark:hover:bg-white/10 transition-all duration-300 group/social border border-white/20 dark:border-slate-600/50"
                    title="GitHub"
                  >
                    <svg className="w-4 h-4 text-slate-600 dark:text-slate-300 group-hover/social:text-slate-800 dark:group-hover/social:text-white transition-colors mr-1.5" fill="currentColor" viewBox="0 0 20 20">
